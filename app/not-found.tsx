  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        {/* Logo/Brand Name */}
        <div className="mb-8">
          <h1 className="text-4xl md:text-6xl font-bold mb-3 tracking-wider" style={{ color: '#f5f3f2' }}>
            MESEKI
          </h1>
        ...
        {/* 404 Content */}
        <div className="mb-8">
          <h2 className="text-8xl md:text-9xl font-bold mb-4" style={{ color: '#f5f3f2' }}>
            404
          </h2>
          <h3 className="text-2xl md:text-3xl font-light mb-4" style={{ color: '#f5f3f2' }}>
            Page Not Found
          </h3>
          <p className="text-base md:text-lg max-w-2xl mx-auto leading-relaxed mb-8" style={{ color: '#f5f3f2' }}>
            The page you're looking for doesn't exist. Let's get you back to where you belong.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link 
            href="/"
            className="px-8 py-3 font-semibold border-2 rounded-lg transition-colors duration-200"
